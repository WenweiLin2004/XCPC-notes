...
![在这里插入图片描述](/assets/img/remote/8089974a6d.png)
```cpp
struct Node{
    int val,id;
...
```
#  A. Arrow a Row(构造)
![在这里插入图片描述](/assets/img/remote/7a9ca17fba.png)
```cpp
int main()
{
	int t;cin>>t;
...
![在这里插入图片描述](/assets/img/remote/9c5cb892b1.png)
![](/assets/img/remote/1dc744f396.png)
...
![在这里插入图片描述](/assets/img/remote/03607d0b33.png)
![在这里插入图片描述](/assets/img/remote/bc344ac0e1.png)
...
![在这里插入图片描述](/assets/img/remote/9a5fac5d9d.png)
![在这里插入图片描述](/assets/img/remote/c7a14650f4.png)
* 将数组划分成若干个不下降序列
...
![在这里插入图片描述](/assets/img/remote/24f4b105eb.png)
![在这里插入图片描述](/assets/img/remote/bbf8397c22.png)
...
```
#  K. Magical Set(费用流)
![在这里插入图片描述](/assets/img/remote/68df2ba641.png)
![在这里插入图片描述](/assets/img/remote/eea2010950.png)
